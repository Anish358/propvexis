...
export const PLANS = {
  free:    { ea: false, metaapi: false, csvImport: true, manual: true, syncedAccounts: 0 },
  pro:     { ea: true,  metaapi: false, csvImport: true, manual: true, syncedAccounts: 3 },
  premium: { ea: true,  metaapi: true,  csvImport: true, manual: true, syncedAccounts: 1 },
};
